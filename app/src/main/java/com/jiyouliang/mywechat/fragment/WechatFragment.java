...
public class WechatFragment extends Fragment {
    ...
    private String[] TITLES = new String[]{"表妹", "UI设计交流群", "微信支付", "梁紫美", "吉彦易-产品经理", "UI设计组群", "携程旅行网", "招商银行", "玮哥"};
    private String[] DESC = new String[]{"堂姐吃饭了没？", "【链接】Sketch必备高大上技能", "微信支付凭证", "帮我设计这个logo", "这是今天开会的资料", "UI组长:下午2:30开会哦！", "机票预订成功通知", "【链接】告诉你个发家致富的秘密", "【红包】中秋节快乐"};
    private int[] RES_IDS = new int[]{R.drawable.friend4, R.drawable.ui_designer_group, R.drawable.wechat_pay, R.drawable.friend2, R.drawable.friend1, R.drawable.group2, R.drawable.logo_ctrip, R.drawable.dianxin, R.drawable.friend3};
    private boolean[] MSG_STATUS = new boolean[]{false, false, true, false, false, true, true, true, true};
